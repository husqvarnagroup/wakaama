...
def generate_object_code(lwm2m_object):
    ...
    code += "lwm2m_object_definition_t *obj = malloc(sizeof(lwm2m_object_definition_t));\n";
...
class GettingStartedTest(unittest.TestCase):
    def test_simple(self):
        with open("/home/lukas/projects/wakaama/object_registry/objects/security_1_1.c", 'w') as o_file:
            o_file.write(code)
